...
export const ridesApi = {
	 ...
	 */
	getRides: (params?: RidesParams): Promise<RideOut[]> => api.get<RideOut[]>('/rides', { params }).then((r) => r.data),

	/** GET /rides/{id} */
	getRide: (id: number): Promise<RideOut> => api.get<RideOut>(`/rides/${id}`).then((r) => r.data),
};

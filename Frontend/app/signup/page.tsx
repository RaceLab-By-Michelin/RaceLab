  ...
  return (
    <AuthLayout title="Créer un compte" subtitle="Commencez le suivi de vos pneus en quelques secondes">
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        <AuthField label="Nom" type="text" value={name} onChange={setName} placeholder="Alex Dupont" autoComplete="name" />
        <AuthField label="Email" type="email" value={email} onChange={setEmail} placeholder="vous@exemple.com" autoComplete="email" />
        <AuthField label="Mot de passe" type="password" value={password} onChange={setPassword} placeholder="8 caractères minimum" autoComplete="new-password" />

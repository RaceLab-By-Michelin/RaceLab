...
export function Badge({
	...
	return (
		<span
			className={`inline-flex items-center gap-1 rounded-full px-2.5 py-1 text-[10px] font-bold tracking-wider uppercase ${className}`}
...
export function MeterBar({
	...
	return (
		<div className={`h-1.5 w-full overflow-hidden rounded-full ${className}`} style={{ background: COLORS.gray10 }}>
			<div
...
export function WearDial({ wear, label, size = 180 }: { wear: number; label: string; size?: number }) {
	const segments = 40;
